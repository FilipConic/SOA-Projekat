...
public final class PurchaseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<purchase.grpc.AddToCartGrpcRequest,
      purchase.grpc.AddToCartGrpcResponse> getAddToCartMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddToCart",
      requestType = purchase.grpc.AddToCartGrpcRequest.class,
      responseType = purchase.grpc.AddToCartGrpcResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<purchase.grpc.AddToCartGrpcRequest,
      purchase.grpc.AddToCartGrpcResponse> getAddToCartMethod() {
    io.grpc.MethodDescriptor<purchase.grpc.AddToCartGrpcRequest, purchase.grpc.AddToCartGrpcResponse> getAddToCartMethod;
      ...
      synchronized (PurchaseServiceGrpc.class) {
        if ((getAddToCartMethod = PurchaseServiceGrpc.getAddToCartMethod) == null) {
          PurchaseServiceGrpc.getAddToCartMethod = getAddToCartMethod =
              io.grpc.MethodDescriptor.<purchase.grpc.AddToCartGrpcRequest, purchase.grpc.AddToCartGrpcResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AddToCart"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  purchase.grpc.AddToCartGrpcRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  purchase.grpc.AddToCartGrpcResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<purchase.grpc.CheckoutGrpcRequest,
      purchase.grpc.CheckoutGrpcResponse> getCheckoutMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Checkout",
      requestType = purchase.grpc.CheckoutGrpcRequest.class,
      responseType = purchase.grpc.CheckoutGrpcResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<purchase.grpc.CheckoutGrpcRequest,
      purchase.grpc.CheckoutGrpcResponse> getCheckoutMethod() {
    io.grpc.MethodDescriptor<purchase.grpc.CheckoutGrpcRequest, purchase.grpc.CheckoutGrpcResponse> getCheckoutMethod;
    if ((getCheckoutMethod = PurchaseServiceGrpc.getCheckoutMethod) == null) {
      synchronized (PurchaseServiceGrpc.class) {
        if ((getCheckoutMethod = PurchaseServiceGrpc.getCheckoutMethod) == null) {
          PurchaseServiceGrpc.getCheckoutMethod = getCheckoutMethod =
              io.grpc.MethodDescriptor.<purchase.grpc.CheckoutGrpcRequest, purchase.grpc.CheckoutGrpcResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Checkout"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  purchase.grpc.CheckoutGrpcRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  purchase.grpc.CheckoutGrpcResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void addToCart(purchase.grpc.AddToCartGrpcRequest request,
        io.grpc.stub.StreamObserver<purchase.grpc.AddToCartGrpcResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddToCartMethod(), responseObserver);
    }

    /**
     */
    default void checkout(purchase.grpc.CheckoutGrpcRequest request,
        io.grpc.stub.StreamObserver<purchase.grpc.CheckoutGrpcResponse> responseObserver) {
  ...
  public static final class PurchaseServiceStub
    ...
    /**
     */
    public void addToCart(purchase.grpc.AddToCartGrpcRequest request,
        io.grpc.stub.StreamObserver<purchase.grpc.AddToCartGrpcResponse> responseObserver) {
    ...
    /**
     */
    public void checkout(purchase.grpc.CheckoutGrpcRequest request,
        io.grpc.stub.StreamObserver<purchase.grpc.CheckoutGrpcResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class PurchaseServiceBlockingStub
    ...
    /**
     */
    public purchase.grpc.AddToCartGrpcResponse addToCart(purchase.grpc.AddToCartGrpcRequest request) {
    ...
    /**
     */
    public purchase.grpc.CheckoutGrpcResponse checkout(purchase.grpc.CheckoutGrpcRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PurchaseServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<purchase.grpc.AddToCartGrpcResponse> addToCart(
        purchase.grpc.AddToCartGrpcRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<purchase.grpc.CheckoutGrpcResponse> checkout(
        purchase.grpc.CheckoutGrpcRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_TO_CART:
          serviceImpl.addToCart((purchase.grpc.AddToCartGrpcRequest) request,
              (io.grpc.stub.StreamObserver<purchase.grpc.AddToCartGrpcResponse>) responseObserver);
          break;
        case METHODID_CHECKOUT:
          serviceImpl.checkout((purchase.grpc.CheckoutGrpcRequest) request,
              (io.grpc.stub.StreamObserver<purchase.grpc.CheckoutGrpcResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              purchase.grpc.AddToCartGrpcRequest,
              purchase.grpc.AddToCartGrpcResponse>(
                service, METHODID_ADD_TO_CART)))
        .addMethod(
          getCheckoutMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              purchase.grpc.CheckoutGrpcRequest,
              purchase.grpc.CheckoutGrpcResponse>(
  ...
  private static abstract class PurchaseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return purchase.grpc.PurchaseProto.getDescriptor();
    }
